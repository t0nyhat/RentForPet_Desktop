...
> 🌐 **Облачная SaaS-версия** с расширенными возможностями скоро будет доступна по адресу [rentforpet.ru](https://rentforpet.ru)
...
Готовые сборки для всех платформ доступны на странице [GitHub Releases](https://github.com/t0nyhat/RentForPet_Desktop/releases).
